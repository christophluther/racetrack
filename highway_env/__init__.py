...
def register_highway_envs():
    ...
    register(
        id='racetrack-large',
        entry_point='highway_env.envs:RacetrackEnvLarge',
    )

    # CL:
    register(
        id='racetrack-loop',
        entry_point='highway_env.envs:RacetrackEnvLoop',
    )
    ...
    register(
        id='racetrack-rewards',
        entry_point='highway_env.envs:RacetrackEnvRewards',
    )
